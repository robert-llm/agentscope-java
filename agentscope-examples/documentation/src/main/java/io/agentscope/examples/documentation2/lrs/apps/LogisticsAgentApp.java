...
/**
 * Logistics Agent application — queries shipping status, tracking events, estimated arrival.
 *
 * <p>Independent application that registers as {@code logistics-agent} External Agent.
 *
 * <p><b>Run:</b>
 * <pre>
 *   mvn exec:java -pl agentscope-examples/documentation \
 *       -Dexec.mainClass=io.agentscope.examples.documentation2.lrs.apps.LogisticsAgentApp
 * </pre>
 */
public class LogisticsAgentApp {
