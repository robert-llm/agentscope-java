...
/**
 * Inventory Agent application — queries available stock across warehouses.
 *
 * <p>Independent application that registers as {@code inventory-agent} External Agent.
 *
 * <p><b>Run:</b>
 * <pre>
 *   mvn exec:java -pl agentscope-examples/documentation \
 *       -Dexec.mainClass=io.agentscope.examples.documentation2.lrs.apps.InventoryAgentApp
 * </pre>
 */
public class InventoryAgentApp {

    private static final Logger log = LoggerFactory.getLogger(InventoryAgentApp.class);
    private static final String AGENT_KEY = "inventory-agent";
    private static final int CONTRACT_PORT = 18093;
    ...
    public static void main(String[] args) throws Exception {
        ...
        HarnessAgent agent = example.buildInventoryAgent(adapter);
